...
async function chatOpenAI(provider, model, system, user, apiKey, baseUrl, maxTokens) {
...
async function chatGemini(model, system, user, apiKey, baseUrl, maxTokens) {
...
async function chatAnthropic(model, system, user, apiKey, baseUrl, maxTokens) {
...
async function invokeProvider(provider, config, system, user) {
  ...
  const raw =
    provider === "anthropic"
      ? await chatAnthropic(model, system, user, apiKey, baseUrl, maxTokens)
      : provider === "gemini"
        ? await chatGemini(model, system, user, apiKey, baseUrl, maxTokens)
        : await chatOpenAI(provider, model, system, user, apiKey, baseUrl, maxTokens);
