...
async function chatOpenAI(provider, model, system, user, apiKey, baseUrl, maxTokens, timeoutMs) {
...
async function chatGemini(model, system, user, apiKey, baseUrl, maxTokens, timeoutMs) {
...
async function chatAnthropic(model, system, user, apiKey, baseUrl, maxTokens, timeoutMs) {
...
async function invokeProvider(provider, config, system, user) {
  ...
  const raw =
    provider === "anthropic"
      ? await chatAnthropic(model, system, user, apiKey, baseUrl, maxTokens, timeoutMs)
      : provider === "gemini"
        ? await chatGemini(model, system, user, apiKey, baseUrl, maxTokens, timeoutMs)
        : await chatOpenAI(provider, model, system, user, apiKey, baseUrl, maxTokens, timeoutMs);
